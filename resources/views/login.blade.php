         ...
         @include('components.errors')
            ...
            <form action="/" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <a href="project"><button type="submit" class="btn btn-primary btn-block">Sign In</button></a>
                    </div>
